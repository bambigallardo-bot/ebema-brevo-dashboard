...
// Páginas máx por listado. 1 = modo liviano (menos llamadas, evita 429). Subir luego.
...
export async function getDashboard() {
  ...
  // Hubo un error transitorio (ej. 429). Si tenemos una copia previa buena,
  // la mostramos (stale) en vez de dejar el dashboard en blanco.
  if (_cache.data) {
    return { ..._cache.data, stale: true, lastError: result.errors.email || result.errors.lists };
  }
  return result;
}
